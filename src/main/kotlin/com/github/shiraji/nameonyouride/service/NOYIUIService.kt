...
import com.github.shiraji.nameonyouride.properties.applyTo
...
class NOYIUIService(private val project: Project) : Disposable {
    ...
    fun prepareLabel() {
        ...
        PropertiesComponent.getInstance(project)?.applyTo(label)
    }
